...
type GeneratedModelResources = {
  readonly so101: {
    ...
    readonly keyframes: {};
    readonly cameras: {
      readonly realsense_d435i: 'realsense_d435i';
  ...
  interface Register {
    models: {
      so101: {
        ...
        sensors: never;
        bodies: 'base' | 'camera_mount' | 'd435i' | 'gripper' | 'lower_arm' | 'moving_jaw_so101_v1' | 'shoulder' | 'upper_arm' | 'wrist';
        joints: 'elbow_flex' | 'gripper' | 'shoulder_lift' | 'shoulder_pan' | 'wrist_flex' | 'wrist_roll';
        sites: 'baseframe' | 'gripperframe';
        geoms: 'camera_box1' | 'camera_box2' | 'fixed_jaw_box1' | 'fixed_jaw_box2' | 'fixed_jaw_box3' | 'fixed_jaw_box4' | 'fixed_jaw_box5' | 'fixed_jaw_box6' | 'fixed_jaw_box7' | 'fixed_jaw_sph_tip1' | 'fixed_jaw_sph_tip2' | 'fixed_jaw_sph_tip3' | 'floor' | 'moving_jaw_box1' | 'moving_jaw_box2' | 'moving_jaw_box3' | 'moving_jaw_sph_tip1' | 'moving_jaw_sph_tip2' | 'moving_jaw_sph_tip3';
        keyframes: never;
        cameras: 'realsense_d435i' | 'wrist_cam';
      };
    };
    actuators: 'elbow_flex' | 'gripper' | 'shoulder_lift' | 'shoulder_pan' | 'wrist_flex' | 'wrist_roll';
    bodies: 'base' | 'camera_mount' | 'd435i' | 'gripper' | 'lower_arm' | 'moving_jaw_so101_v1' | 'shoulder' | 'upper_arm' | 'wrist';
